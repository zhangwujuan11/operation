	...
	<div class="maincon">
		...
		<div class="infobox">
			<div class="inputBox">
				...
				<el-input placeholder="退款/支付/渠道/商户退款订单号" v-model="ruleForm.unionOrderId"></el-input>
				...
				<el-input placeholder="应用APPID"  v-model="ruleForm.appId"></el-input>
				 ...
				 <el-select  v-model="ruleForm.state" placeholder="退款状态">
				  ...
				  <el-select  v-model="ruleForm.mchType" placeholder="商户类型">
				     <el-option
...
<script>
	...
	import Table from '@/components/ordermanagement/Refundtable.vue'
