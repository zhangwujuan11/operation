	...
	<div class="maincon">
		...
		<div class="infobox">
			<div class="inputBox">
				...
				<el-input placeholder="转账/商户/渠道订单号" v-model="ruleForm.unionOrderId"></el-input>
				<el-input placeholder="商户号" v-model="ruleForm.mchNo"></el-input>
				<el-input placeholder="应用APPID" v-model="ruleForm.appId"></el-input>
				 <el-select  v-model="ruleForm.state" placeholder="转账状态">
				    <el-option
...
<script>
	...
	import Table from '@/components/ordermanagement/Transfertable.vue'
	export default{
		components:{
			Travelpermit,
			Table
