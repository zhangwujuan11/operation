<template>
	<div class="datable">
		<el-table :data="tableData.slice((currentPage-1)*PageSize,currentPage*PageSize)"
			...
			<el-table-column prop="ccName" label="码牌名称">
			</el-table-column>
			<el-table-column prop="id" label="码牌ID">
			</el-table-column>
			<el-table-column prop="createAt" label="创建时间">
			</el-table-column>
			<el-table-column width='280' prop="remark" label="备注">
			</el-table-column>
		...
		<!-- 蒙尘 -->
		<el-dialog title="修改码牌配置" append-to-body :visible.sync="dialogVisible" width="50%">
			<div class="chen">
...
<script>
	...
	import {ccinfoserchall,ccinfoserch,ccinfoupdata,ccinfodel} from '@/utils/mchinfo.js'
	// import {
	// 	mchApps,
	// 	delapp,
	// 	putapp,
		...
		methods: {
			...
			submitForm(formName) {
				this.$refs[formName].validate((valid) => {
					if (valid) {
						ccinfoupdata(this.ruleForm).then(res=>{
